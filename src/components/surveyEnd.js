...
function SurveyEndPage() {
    ...
    const surveyJson = {
        ...
        },
        {
            ...
            type: "text",
            name: "How many times did you click the “Inspiration” button?",
            title: "How many times did you click the “Inspiration” button?",
            isRequired: true
          }
      ,
      {
        ...
        type: "text",
        name: "Do you feel the inspirations sparked new ideas for your composition?",
        title: "Do you feel the inspirations sparked new ideas for your composition?",
        isRequired: true
      },
      {
                
        type: "text",
        name: "How relevant were the inspirations to your music?",
        title: "How relevant were the inspirations to your music?",
        isRequired: true
      },
      {
                
        type: "text",
        name: "Did you update your composition based on the suggestions? If yes, what were the updates you made to your music?",
        title: "Did you update your composition based on the suggestions? If yes, what were the updates you made to your music?",
        isRequired: true
      },
      {
    ...
    const alertResults = useCallback((sender) => {
        ...
        axios.post('https://fantasifreely.de/'+"submitSurvey",JSON.stringify(payload), {
            headers: {
